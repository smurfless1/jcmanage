...
from jcmanage.libs.calleridentry import callerIdEntry
...
class TestCallerIdEntry(unittest.TestCase):
    def given_a_new_entry(self):
        ...
        self.entry.fromString(
            "W-DATE = 061913--TIME = 0848--NMBR = 8885551212--NAME = ISELLYOURSOUL  --"
        )
    ...
    def test_getKey(self):
        self.given_an_entry()
        self.assertEqual("ISELLYOURSOUL?     8885551212?        ", self.entry.getKey())
    ...
    def test_getValue(self, read):
        ...
        self.assertEqual(2, len(self.entry.getValue()))
    ...
    @patch("__builtin__.raw_input", "__builtin__.print")
    def test_entries_comparable(self, read, printy):
        ...
        self.assertEqual(self.entry.getKey(), entry2.getKey())
        self.assertEqual(self.entry, entry2)
