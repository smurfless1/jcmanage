...
from libs.calleridentry import callerIdEntry
...
username = os.environ.get("USER", "UNSET_USERNAME")
api_key = keyring.get_password("whocalledus", username)
wc = whocalled(username, api_key)
